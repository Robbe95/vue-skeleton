...
import { CheckboxGroupContext } from '@/ui/composables/checkbox/useCheckboxContext'
import type { CheckboxStateDefinition } from '@/ui/composables/checkbox/useCheckboxContext'
...
function compareFunction(a: any, b: any): boolean {
  if (props.keyValue)
...
function removeValue(value: any): void {
