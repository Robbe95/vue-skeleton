...
<template>
  <div>
    <Component
      ...
      class="flex w-full items-center justify-between gap-2 rounded-button bg-primary/50 px-2 py-1 transition hover:bg-primary/20"
      :to="to"
    ...
    <TransitionExpand>
      <div
        v-if="hasChildren && childrenOpen" class="rounded-button bg-primary"
      >
